...
$tint_level = keystone_gtmwi('cmb2_id_field_swiper_image_tint', $instance);
...
<?php
  ...
  $slider_options = [
      'autoplay'      => bool2truthy(keystone_gtmwi('cmb2_id_field_swiper_autoplay', $instance)),
      'loop'          => bool2truthy(keystone_gtmwi('cmb2_id_field_swiper_loop_mode', $instance)),
      'speed'         => intVal(keystone_gtmwi('cmb2_id_field_swiper_speed', $instance)),
      'direction'     => keystone_gtmwi('cmb2_id_field_swiper_direction', $instance),
      'freeMode'      => bool2truthy(keystone_gtmwi('cmb2_id_field_swiper_freemode', $instance)),
      'centerSlides'  => bool2truthy(keystone_gtmwi('cmb2_id_field_swiper_center_slides', $instance)),
      'spaceBetween'  => intVal(keystone_gtmwi('cmb2_id_field_swiper_space_between_slides', $instance)),
      'slidesPerView' => intVal(keystone_gtmwi('cmb2_id_field_swiper_slides_per_view', $instance)),
      'keyboard'      => [
          'enabled' => bool2truthy(!keystone_gtmwi('cmb2_id_field_swiper_disable_keyboard', $instance))
      ],
      'lazy'        => bool2truthy(keystone_gtmwi('cmb2_id_field_swiper_lazy', $instance)),
      'autoHeight'  => bool2truthy(keystone_gtmwi('cmb2_id_field_swiper_auto_height', $instance))
  ];
