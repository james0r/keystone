...
if( !class_exists( 'CMB2_Field_Order' ) ) {
    ...
    class CMB2_Field_Order {
        ...
        public function setup_admin_scripts() {
            wp_register_script( 'cmb-field-order',  get_template_directory_uri() . '/includes/libs/CMB2/plugins/cmb2-field-order/js/order.js', __FILE__ , array( 'jquery', 'jquery-ui-sortable' ), self::VERSION, true );
            wp_enqueue_script( 'cmb-field-order' );

            wp_enqueue_style( 'cmb-field-order', get_template_directory_uri() . '/includes/libs/CMB2/plugins/cmb2-field-order/css/order.css', array(), self::VERSION );
