...
class Keystone_Modules {
  public function __construct() {
    ...
    add_action('cmb2_admin_init', array($this, 'register_module_fields'));
    add_action('after_switch_theme', array($this, 'createModulesTable'));
  }
  ...
  private function get_modules_scripts_map() {
    return array(
      ...
      'about'            => array('twenty-twenty-js', 'event-move-js'),
      'services-style-1' => array()
    );
  }
  ...
  private function get_modules_styles_map() {
    return array(
      ...
      'about'            => array('twenty-twenty-css', 'module-about-css'),
      'services-style-1' => array('flaticon-medical-css', 'flaticon-dental-css', 'module-services-style-1-css')
    );
  }
}
