...
$cmb2_box_header_options = new_cmb2_box(array(
...
$cmb2_box_header_options->add_group_field($cmb2_group_header_style, array(
  ...
  'attributes'    => array(
    ...
    'data-conditional-value'  => wp_json_encode(array('header-modern-style-1')),
  ),
));
...
$cmb2_box_header_options->add_group_field($cmb2_group_header_style, array(
  ...
  'attributes'    => array(
    'data-conditional-id'     => 'layout',
    'data-conditional-value'  => wp_json_encode(array('header-modern-style-2',
...
$cmb2_header_widget_1 = $cmb2_box_header_options->add_field(array(
...
$cmb2_box_header_options->add_group_field($cmb2_header_widget_1, array(
...
$cmb2_box_header_options->add_group_field($cmb2_header_widget_1, array(
  'name'    => __('Make Line 2 a link?', 'keystone'),
  'desc'    => __('Choose a type of link, or choose Plain Text if line should not be clickable.', 'keystone'),
  'id'      => 'make-link',
  'type'    => 'radio_inline',
  'options' => array(
    'plain-text'           => __('Plain Text', 'keystone'),
    'email'                => __('Email', 'keystone'),
    'phone'                => __('Phone', 'keystone'),
    'website'              => __('Website', 'keystone'),
    'physical-address'     => __('Physical Address', 'keystone'),
  ),
  'default' => 'plain-text',
));

$cmb2_header_widget_2 = $cmb2_box_header_options->add_field(array(
...
$cmb2_box_header_options->add_group_field($cmb2_header_widget_2, array(
  'name'        => __('Icon Classes', 'keystone'),
  'id'          => 'icon',
  'desc'        => __('For example:', 'keystone') . ' <b>fas fa-camera</b>' . '<br><br>' . __('To reference an icon, you need to know two bits of information. 1) its name, prefixed with fa- (if you choose a Font Awesome Icon) and 2) the style you want to use’s corresponding prefix**. For icons from the Flaticon set you only need to enter a single class. Example: .flaticon-dental-amalgam-capsule', 'keystone'),
  'type'        => 'text',
...
$cmb2_header_widget_3 = $cmb2_box_header_options->add_field(array(
...
$cmb2_box_header_options->add_group_field($cmb2_header_widget_3, array(
  'name'        => __('Icon Classes', 'keystone'),
  'id'          => 'icon',
  'desc'        => __('For example:', 'keystone') . ' <b>fas fa-camera</b>' . '<br><br>' . __('To reference an icon, you need to know two bits of information. 1) its name, prefixed with fa- (if you choose a Font Awesome Icon) and 2) the style you want to use’s corresponding prefix**. For icons from the Flaticon set you only need to enter a single class. Example: .flaticon-dental-amalgam-capsule', 'keystone'),
  'type'        => 'text',
...
$cmb2_header_cta = $cmb2_box_header_options->add_field(array(
  'id'          => $prefix . 'group_cta',
  'type'        => 'group',
  // 'description' => __( 'Generates reusable form entries', 'cmb2' ),
  'repeatable'  => false, // use false if you want non-repeatable group
...
$cmb2_box_header_options->add_group_field($cmb2_header_cta, array(
...
$cmb2_header_advanced = $cmb2_box_header_options->add_field(array(
...
$cmb2_box_header_options->add_group_field($cmb2_header_advanced, array(
